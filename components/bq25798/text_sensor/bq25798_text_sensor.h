...
class BQ25798TextSensor : public sensor::Sensor,
 ...
 public:
  ...
  void assign_text_sensor_iindpm_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vindpm_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_wd_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_poorsrc_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_pg_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ac2_present_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ac1_present_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbus_present_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_chg_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ico_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbus_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_treg_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbat_present_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_bc1_2_done_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_dpdm_done_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_adc_done_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vsys_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_chg_tmr_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_trichg_tmr_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_prechg_tmr_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_topoff_tmr_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbatotg_low_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ts_cold_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ts_cool_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ts_warm_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ts_hot_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ibat_reg_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbus_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vbat_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ibus_ocp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_ibat_ocp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_conv_ocp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vac2_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vac1_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vsys_short_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_vsys_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_otg_ovp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_otg_uvp_flag(text_sensor::TextSensor *sensor);
  void assign_text_sensor_tshut_flag(text_sensor::TextSensor *sensor);
 ...
 protected:
  ...
  text_sensor::TextSensor *text_sensor_iindpm_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vindpm_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_wd_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_poorsrc_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_pg_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ac2_present_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ac1_present_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbus_present_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_chg_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ico_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbus_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_treg_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbat_present_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_bc1_2_done_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_dpdm_done_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_adc_done_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vsys_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_chg_tmr_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_trichg_tmr_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_prechg_tmr_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_topoff_tmr_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbatotg_low_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ts_cold_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ts_cool_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ts_warm_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ts_hot_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ibat_reg_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbus_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vbat_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ibus_ocp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_ibat_ocp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_conv_ocp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vac2_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vac1_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vsys_short_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_vsys_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_otg_ovp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_otg_uvp_flag_ {nullptr};
  text_sensor::TextSensor *text_sensor_tshut_flag_ {nullptr};
