...
I2CESPHome::I2CESPHome() : I2CGeneric() {
  _chip_address = 0;
}

bool I2CESPHome::i2c_begin(uint8_t chip_address) {
  ...
  void I2CESPHome::i2c_end() {}
  
  bool I2CESPHome::i2c_isConnected() {
    _wire->beginTransmission(_chip_address);
    return (_wire->endTransmission(true) == 0);
  }
  
  uint8_t I2CESPHome::i2c_readReg8(int reg) {
    _clearI2CError();
  ...
  void I2CESPHome::i2c_writeReg8(int reg, uint8_t value) {
    _clearI2CError();
  ...
  uint16_t I2CESPHome::i2c_readReg16(int reg) {
    _clearI2CError();
  ...
  void I2CESPHome::i2c_writeReg16(int reg, uint16_t value) {
    _clearI2CError();
